...
USAGE:
    ...
    pip install azure-ai-projects azure-ai-inference azure-identity azure-monitor-opentelemetry azure-ai-textanalytics
...
language_endpoint = os.environ.get('AZURE_AI_LANGUAGE_SERVICE')
...
with AIProjectClient.from_connection_string(
    ...
    project_client.telemetry.enable(language_client=text_analytics_client)
